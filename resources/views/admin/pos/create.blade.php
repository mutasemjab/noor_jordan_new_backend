...
@section('title', __('messages.add_pos'))

@section('content')

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title">{{ __('messages.add_pos') }}</h1></div>
...
<div class="panel-card">
    <div class="panel-card-header"><h2 class="panel-card-title">{{ __('messages.pos_info') }}</h2></div>
    <div class="panel-card-body">
        <div class="row g-3">
            ...
            <div class="col-12">
                <button type="submit" class="btn-primary-sm"><i class="bi bi-save"></i> {{ __('messages.save_pos') }}</button>
            </div>
        </div>
    </div>
</div>
