...
@section('title', 'تعديل باص')

@section('content')

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title">تعديل الباص: {{ $bus->name }}</h1></div>
    ...
    <div class="panel-card-body">
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="number" name="capacity" value="{{ old('capacity', $bus->capacity) }}" min="1" max="200"
            ...
            <div class="col-12">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                           id="is_active" @checked(old('is_active', $bus->is_active))>
                    <label class="form-check-label" for="is_active">نشط</label>
                </div>
            </div>
            <div class="col-12">
                <button type="submit" class="btn-primary-sm"><i class="bi bi-save"></i> حفظ التعديلات</button>
            </div>
        </div>
    </div>
</div>
