            ...
            <tbody>
                ...
                @foreach($questionBanks as $exam)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ asset('assets/uploads/questionBank/'.$exam->pdf_file) }}"
                               target="_blank">
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.question-banks.edit',$exam->id) }}"
                               class="btn btn-warning btn-sm">
                                {{ __('messages.Edit') }}
                            </a>

                            <form method="POST"
                                  action="{{ route('admin.question-banks.destroy',$exam->id) }}"
